...
// v3: الموقع تحوّل من تذكير بالدوا إلى رسالة فرح. رفع الرقم يمسح كل نسخة
// مخزّنة من الموقع القديم عند أول زيارة، فلا ترى رغد صفحة الدوا من الذاكرة.
const VERSION = 'raghd-v3';
